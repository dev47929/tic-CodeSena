...
export default function SentimentAnalysis() {
    ...
    return (
        <div className="w-full min-h-full flex flex-col relative py-6 px-4 lg:px-8">
            <div className="absolute inset-0 bg-[#0A0A0A]/60 backdrop-blur-md rounded-2xl border border-[#333]/50 -z-10" />

            {!isCompleted && (
                <div className="text-center mb-4 shrink-0 mt-auto">
                    <div className="mx-auto w-12 h-12 rounded-full bg-[#c47ea8]/20 border border-[#c47ea8]/40 flex items-center justify-center mb-2">
                        <BrainCircuit size={24} className="text-[#c47ea8]" />
                    </div>
                    <h2 className="text-2xl font-serif text-white font-bold mb-1">Sentiment Assessment</h2>
            ...
            {!isCompleted ? (
                <Stepper
                    ...
                    stepCircleContainerClassName="!max-w-2xl bg-[#111]/80 backdrop-blur-xl border border-[#333]/50 shadow-2xl relative z-20"
                    ...
                    {questions.map((q) => (
                        <Step key={q.id}>
                            <div className="py-2 min-h-[160px]">
                                <h3 className="text-lg font-semibold text-gray-200 mb-1">{q.title}</h3>
                ...
                <div className="w-full max-w-2xl mx-auto my-auto bg-[#111111]/90 backdrop-blur-xl p-10 rounded-4xl border border-[#c47ea8]/30 shadow-2xl text-center flex flex-col items-center">
                    ...
                    <h3 className="text-2xl font-semibold text-white mb-4">Assessment Complete</h3>
                    ...
                    <button 
                        ...
                        className="px-6 py-2.5 rounded-full bg-[#1F1F1F] text-gray-300 font-medium hover:bg-[#2A2A2A] transition-colors border border-[#333]"
                    >
                        Retake Assessment
                    </button>
                </div>
